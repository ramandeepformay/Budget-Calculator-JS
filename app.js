...
var UIController = (function() {
    ...
    return {
        ...
        displayPercentages : function (percentage) {
			var expPercentageList = document.querySelectorAll(DOMstrings.expensesPercLabel);
 
			for(var i=0; i < expPercentageList.length ; i++) {				
				if(percentage[i] > 0) {
					expPercentageList[i].textContent = percentage[i] + '%';	
				} else {
					expPercentageList[i].textContent = '---';
				}
        ...
        changeType:function(){
            ...
            var fieldButton =document.querySelector(DOMstrings.inputBtn).classList.toggle("red");
            console.log(fields);
...
var controller = (function(budgetCtrl, UICtrl){
     ...
     var setupEventListeners = function(){
          ...
          var DOM = UICtrl.getDOMstrings();
            ...
            document.querySelector(DOM.inputType).addEventListener("onChange", UICtrl.changeType());
     };
